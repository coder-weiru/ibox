...
public class DeleteActivityHandlerTest {
    ...
    @InjectMocks
    private DeleteActivityHandler handler = new DeleteActivityHandler();
    ...
    public void getActivity_shouldInvokeActivityDateServiceWithActivityId() throws Exception {
        ...
        when(activityDataServiceMock.deleteActivity(any(String.class))).thenReturn(activity);
        ...
        verify(activityDataServiceMock, times(1)).deleteActivity(activityIdCaptor.capture());
    ...
    public void getActivity_shouldReturnInternalServerErrorMessageIfAmazonServiceExceptionIsThrown() throws Exception {
        ...
        doThrow(amazonDynamoDBException).when(activityDataServiceMock).deleteActivity(any(String.class));
