...
public class DeleteEventHandlerTest {
    ...
    @InjectMocks
    private DeleteEventHandler handler = new DeleteEventHandler();
    ...
    public void getEvent_shouldInvokeEventDateServiceWithEventId() throws Exception {
        ...
        verify(eventDataServiceMock, times(1)).deleteEvent(eventIdCaptor.capture());
    ...
    public void getEvent_shouldReturnInternalServerErrorMessageIfAmazonServiceExceptionIsThrown() throws Exception {
        ...
        doThrow(amazonDynamoDBException).when(eventDataServiceMock).deleteEvent(any(String.class));
